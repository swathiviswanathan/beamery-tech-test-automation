...
exports.config = {
  ...
  afterScenario: function (
    ...
    const output =
      ...
      `  ${browser.userDetails.emailId} ${browser.userDetails.password} ${result.status} \n`;
    fs.appendFile("./src/testData/userDetails.txt", output, function (err) {
      if (err) {
        return console.log(err);
      }
      console.log("The userDetails file is saved");
    });
